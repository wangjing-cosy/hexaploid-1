...
# that unlike a case in diploids using one generation to attain HWE, all genotype frequencies in hexaploids will not reach absolute equilibrium, rather tend to be stable after 8 – 9 generations of random mating, as opposed to 5 – 6 generations in tetraploids. 
